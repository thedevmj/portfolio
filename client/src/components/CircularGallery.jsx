...
export default React.memo(function CircularGallery({
  ...
  useEffect(() => {
    ...
    // Only create (and keep running) the WebGL scene while the gallery is
    // actually visible — avoids a permanent requestAnimationFrame loop and
    // a live GPU context when the section is off-screen.
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Skills gallery. Use Left and Right Arrow keys, or drag, to explore."
      ref={containerRef}
    />
  );
})
